          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6 items-end">
              ...
              <div class="col-span-6 sm:col-span-1 ">
                  <button className='w-full text-xl font-medium text-white bg-red-600 border border-transparent rounded-md h-11 shadow-xm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500'>
                        Post
                  </button>
              </div>
