        ...
        <>
            <section class="section-content-block section-client-testimonial">
                ...
                <div class="container">
                    ...
                    <div class="testimonial-container text-center owl-carousel owl-theme owl-loaded">

                 

                        <div class="owl-stage-outer"><div class="owl-stage" style={{transform: "translate3d(-2820px, 0px, 0px)", transition:" all 0.25s ease 0s", width: "6580px"}}><div class="owl-item cloned" style={{width: "940px", marginRight: "0px"}}><div class="col-md-10 col-md-offset-1 col-sm-12">
                        ...
                        </div></div><div class="owl-item cloned" style={{width: "940px", marginRight: "0px"}}><div class="col-md-10 col-md-offset-1 col-sm-12">
                        ...
                        </div></div><div class="owl-item"style={{width: "940px", marginRight: "0px"}}><div class="col-md-10 col-md-offset-1 col-sm-12">
                        ...
                        </div></div><div class="owl-item active" style={{width: "940px", marginRight: "0px"}}><div class="col-md-10 col-md-offset-1 col-sm-12">
